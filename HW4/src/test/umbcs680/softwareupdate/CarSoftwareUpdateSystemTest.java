...
class  CarSoftwareUpdateSystemTest {
    ...
    void Lamborghini_Software_Updates() {
        ...
        assertTrue(aventador.getReceivedUpdates().contains("v10.22.5 - Quick Shifters Update"));
        assertTrue(hurricane.getReceivedUpdates().contains("v10.22.5 - Quick Shifters Update"));
        ...
        assertTrue(aventador.getReceivedUpdates().contains("v11.0.55 - AI Powered Voice Controls"));
        assertFalse(hurricane.getReceivedUpdates().contains("v11.0.55 - AI Powered Voice Controls"));
    }
        ...
        void Ferrari_Software_Updates () {
            ...
            assertTrue(Spider.getReceivedUpdates().contains("v10.22.5 - Quick Shifters Update"));
            assertTrue(GTB.getReceivedUpdates().contains("v10.22.5 - Quick Shifters Update"));
            ...
            assertTrue(GTB.getReceivedUpdates().contains("v11.0.55 - AI Powered Voice Controls"));
            assertFalse(Spider.getReceivedUpdates().contains("v11.0.55 - AI Powered Voice Controls"));
        }
    }
