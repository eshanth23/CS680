...
public class SizeComparatorTest {
    ...
    @Test
    public void Root_Children_SizeSorting() {
        List<FSElement> rootChildren = new ArrayList<>(root.getChildren());
        rootChildren.sort(Comparator.comparing(FSElement::getSize));
    ...
    @Test
    public void hw01_Children_SizeSorting() {
        Directory hw01 = null;
        ...
        hw01Children.sort(Comparator.comparing(FSElement::getSize));
    ...
    @Test
    public void Src_Children_SizeSorting() {
        Directory hw01 = null;
        for (FSElement element : root.getChildren()) {
            if (element.getName().equals("hw01") && element instanceof Directory) {
                hw01 = (Directory) element;
        ...
        srcChildren.sort(Comparator.comparing(FSElement::getSize));
